...
export default function CloseCallTile() {
  return (
    <figure className="wc-tile wc-tile--close-call">
      ...
      <figcaption className="wc-caption">
        Almost stopped — the system saw the effort but couldn't credit the stop. Hold the near-stop for the full three seconds.
      </figcaption>
    </figure>
  )
}
